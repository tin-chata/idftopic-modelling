...
if __name__ == '__main__':
    """
    screen python model.py --train_file ../data/yelp/yelp_data_rev.pro.txt --word_emb_file ../data/embedding/w2v_yelp100.pro.vec --use_cuda --sent_limit -1 --grad_flag --max_epochs 32 --shutdown --kmean_file ./kmean_10centroids.txt 
    """
